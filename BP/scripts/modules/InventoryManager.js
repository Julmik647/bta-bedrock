...
console.warn("[Betafied] Inventory Manager Loaded");

// config
const CHECK_INTERVAL = 20; // every second
const MESSAGE_COOLDOWN = 60;
const REMOVE_MSG = "§c[Betafied] §7That item doesn't exist in Beta 1.7.3!";
...
function processInventory(player) {
    ...
    for (let i = 0; i < inv.size; i++) {
        ...
        // 1. food conversions (spawn individual unstackable items)
